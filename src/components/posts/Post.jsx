...
function Post(props) {
  ...
  return (
    <li className="bg-white shadow-md p-1 rounded top-0">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl uppercase md:w-4/5 w-1/2 whitespace-nowrap text-ellipsis overflow-hidden">
          {post.title}
        </h2>
        <div className="flex items-center justify-between gap-2">
          <button
            className="px-1 duration-300 hover:scale-110 active:saturate-50 active:scale-100"
          ...
          >
            ...
            >
              ...
              <polygon
                fill="#9aa2e6"
                points="22.806,28.303 32.767,86.438 67.828,86.438 77.79,28.303"
              />
              <path
                fill="#707cc0"
      ...
      <div>
        <p className="overflow-text-ellipsis">{post.body}</p>
      </div>
    </li>
  );
}
